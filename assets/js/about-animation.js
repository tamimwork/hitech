...
$(document).ready(function () {
    ...
    if (headingEl) {
        ...
        // প্রতিটি word কে আলাদা span এ মুড়িয়ে দাও (Fix: added template literal backticks)
    ...
    gsap.fromTo(
        [".about__tab-items", ".about__quets", ".about__btn-wrap"],
        { opacity: 0, y: 28 },
        {
            opacity: 1,
            y: 0,
...
$(function () {
    ...
    $(document).on('click', '.about-modal-overlay', function (e) { 
